...
@endsection
@section('title','Cempyen || Content Detail')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="product-buy">
												...
												<span><p class="cat">Category :<span class="badge badge-danger"><a style="margin:auto" href="{{route('product-cat',$product_detail->cat_info['slug'])}}">{{$product_detail->cat_info['title']}}</a></p></span>
												...
												<div class="single-des">
													...
													<span><p class="cat"><span class="badge badge-link" ><a style="margin:auto;font-size:20px" href="{{($product_detail->description)}}">Link Terabox</a></p></span>
												...
												{{-- <div class="tab-pane fade show active" id="description" role="tabpanel">
													<div class="tab-single">
														<div class="row">
															<div class="col-12">
																<div class="single-des">
																	<p class="cat"><span class="badge badge-info"><a href="{{($product_detail->description)}}">Link Terabox</a></p></span>
                                ...
                                <div class="single-product">
                                    <div class="product-img">
										<a href="{{route('product-detail',$data->slug)}}">
                                            ...
                                            <span class="price-dec"> Link </span>
